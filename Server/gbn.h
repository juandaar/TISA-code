...
#define TIMEOUT      ((TIMEBETWEENPACKETS/1000)*(2.2)*(MAX_WINDOW_SIZE*0.5))                  /* timeout to resend packets (microsseconds)        */
#define TIMEBETWEENPACKETS 250000 /* 200 microseconds*/ 
#define ACTUAL_TIME 10
#define SURVIVER_PACKET 60000 /*60 seconds*/
#define SURVIVER_ACK  120000   /*120 seconds*/
/*----- Packet types -----*/
